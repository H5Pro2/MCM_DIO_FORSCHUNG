...
Dieser alte Umsetzungsplan bleibt als historische Referenz erhalten.
Der aktive neue Bauplan liegt hier:

- `BAUPLAN.md`
- `../../DIO_2/konstruktion/00_BAUPLAN.md`

Neue Architekturentscheidungen werden zuerst dort schriftlich sauber aufgebaut,
damit daraus ein Konstruktionsplan für DIO entsteht.
...
- Block V beschreibt, wie eine KI die starre Logik auf Verhaltensebene
  ...
  Zustandsbildung entstehen. Für DIO bedeutet das konkret: Code und
  Berechnung bleiben die technische Grundschicht, aber die eigentliche
  Entscheidungsebene soll nicht als starre Wenn-Dann-Kette wirken. DIO soll
  innere Zustände modellieren, diese Zustände auf sich selbst zurückführen
  und daraus Handlung, Nicht-Handlung, Beobachtung oder Reorganisation
  ableiten. Die aktuelle Meta-Regulation ist genau diese Brücke: Impuls,
  Wahrnehmung und Hypothese dürfen Handlung vorbereiten, aber Rückführung,
  Distanz, Überkopplung und innere Tragfähigkeit entscheiden mit, ob daraus
  echte Motorik wird.
...
Diese interne Sprache soll langfristig nicht nur benennen, sondern tragen.
Ein DIO-Zeichen verbindet im Zielzustand sichtbare Formseite und innere
MCM-Feldwirkung. Eine äußere Teilform kann eine MCM-Erinnerung aufrufen; eine
MCM-Feldwirkung kann umgekehrt eine mögliche äußere Teilform als Gedankenkeim
aufrufen. Daraus entsteht eine Hypothese, die nicht sofort Wahrheit ist,
sondern geprüft werden muss:

- passt die aktuelle sichtbare Form zu diesem erinnerten MCM-Gefühl?
- passt das aktuelle MCM-Gefühl zu dieser sichtbaren Form?
- entsteht daraus Vertrauen, Vorsicht, Reorganisation, Beobachtung oder
  Handlung?

Der technische Zielpfad dafür ist:

`Teilform -> MCM-Erinnerung -> Hypothese -> Sicht/Feld-Gegenprüfung -> Konsequenzspur -> gereifte Syntax`

Menschliche Begriffe sind dabei nur Entwicklerübersetzung. DIOs eigentliche
Innenrealität soll in eigener verdichteter Syntax liegen, die Form,
Feldwirkung, Erinnerung, Konsequenz und Reife gemeinsam trägt.


Wichtig ist die Realitaetstrennung:

- Die aeussere Realitaet ist das, was tatsaechlich vor DIO geschieht.
- Eine Hypothese ist nur eine innere Deutung zu dieser realen Form.
- Der Speicheranker bleibt die reale Form-/MCM-Lage.
- Der Gedanke wird als Spur an diese Lage gebunden und spaeter mit dem realen
  Verlauf verglichen.

DIO soll also nicht lernen: "Meine Hypothese ist Realitaet."
DIO soll lernen: "Bei dieser realen Form hatte ich diesen Gedanken; der
spaetere Verlauf hat ihn getragen, widerlegt oder reorganisiert."
...
- der Kerzenstrom erzeugt fortlaufend Teilformen und Musterfolgen
- nicht die einzelne Kerze wird durchdacht, sondern die entstehende
  Form-/MCM-Spur kann Handlungsdruck erzeugen
...
Erweiterung offener Hypothesen:
Offene Strukturhypothesen duerfen nicht automatisch motorisch werden. Wenn ein
Gedankenkeim als `open_structural_hypothesis` erscheint, aber noch
`seed_reinterpret`, schwache Realitaetsbindung, schwache Erdung oder hohe
offene Hypothesenspannung zeigt, wird er zuerst als Replay-/Beobachtungs- oder
Replan-Material behandelt. Bestaetigte Strukturdeutungen und getragene
Hypothesen bleiben handlungsfaehig.
...
## 18.8 MCM-Variantenraum / emergente Möglichkeitsbildung

Ziel:
DIO soll eine wahrgenommene Teilform nicht sofort auf eine feste Bedeutung oder
Handlung schließen. Eine Teilform kann mehrere mögliche Fortsetzungen tragen.
Diese Möglichkeiten werden als offener MCM-Variantenraum gehalten und erst
durch weitere Wahrnehmung, MCM-Resonanz, Zeitlage, Doppler-Nachhall,
Erinnerung und Konsequenz weich verdichtet.

Wichtig:
Das ist keine neue Trading-Regel und kein Signalfilter. Der Variantenraum gibt
DIO Freiheit, mehrere mögliche Deutungen gleichzeitig zu tragen:

- mögliche Long-Fortsetzung
- mögliche Short-Fortsetzung
- beobachtender Abstand
- Reorganisation / Replay

Handlung entsteht daraus nur, wenn Innenlage, Außenform, Zeitbindung,
Erinnerung und Reife gemeinsam tragfähig werden. Offene Varianten dürfen auch
nur beobachtet, nachgereift oder verworfen werden.
...
MCM-Bedeutung:
Der Variantenraum ist die technische Annäherung an emergentes Denken. DIO
bekommt keinen fertigen Schluss, sondern einen Raum möglicher Verdichtungen.
Er kann dadurch prüfen:
"Welche Variante trägt gerade Form, Feld, Zeit und Erinnerung am besten?"
und gleichzeitig offen halten:
"Welche Variante ist noch nur Vorhall, Gedanke oder Hypothese?"

Beispiel:
DIO sieht eine Teilform mit Druck und Nachhall. Statt sofort zu handeln, öffnet
er Varianten: Fortsetzung, Gegenbewegung, Beobachtung oder Reframing. Erst wenn
eine dieser Varianten durch weitere Realität, MCM-Passung und Erinnerung
tragfähiger wird, darf sie näher an Handlung heran.

---

## 18.9 Doppelspalt-Analogie: Beobachter, Variante und Reife

Ziel:
Der MCM-Variantenraum soll nicht nur mehrere Moeglichkeiten erzeugen, sondern
auch lernen, wie Beobachtung diese Moeglichkeiten veraendert. Die
Doppelspalt-Analogie wird dabei nicht physikalisch als feste Marktregel
verstanden, sondern als Architekturprinzip:

Eine Teilform bleibt zuerst als Moeglichkeitswolke offen. Erst durch
Beobachtung, Wiederkehr, Realitaetskontakt, MCM-Resonanz, Konsequenz und
Erinnerung verdichtet sich eine Variante zu mehr Vertrauen, Vorsicht,
Reorganisation oder Handlungsnaehe.

Wichtig:
Auch diese Schicht darf kein mechanischer Kollaps werden. DIO bekommt keine
Regel wie: "Wenn Variante X am staerksten ist, dann handle." Die Beobachtung
selbst ist Teil des Lernprozesses. Eine nicht ausgefuehrte Variante kann
spaeter als tragend, belastend oder neutral bewertet werden. Daraus entsteht
Hypothesenreife, nicht Zwang.

Technische Zielachsen:

- `possibility_observer_state`
- `possibility_observation_depth`
- `possibility_observed_without_action`
- `possibility_observed_confirmation`
- `possibility_observed_rejection`
- `possibility_observed_neutrality`
...
- Varianten entstehen aus Form, MCM-Feld, Zeitlage, Doppler-Nachhall,
  Erinnerung und innerer Lage.
- Beobachtung haelt Varianten offen, statt sie sofort motorisch zu schliessen.
- Eine Variante kann ohne Trade weiterlaufen und spaeter bewertet werden.
- Bestaetigte Varianten duerfen mehr Vertrauen und Aufmerksamkeit bekommen.
- Nicht tragende Varianten erzeugen Vorsicht, Abstand oder Reorganisation.
- Widerspruechliche Varianten bleiben als offene Lernspannung erhalten.

Beispiel:
DIO sieht eine Teilform, die Long, Short, Wait und Replan gleichzeitig als
Moeglichkeiten traegt. Die staerkste Variante ist noch kein Befehl. DIO
beobachtet den weiteren Verlauf. Wenn die Long-Variante ohne Handlung
mehrfach tragend gewesen waere, bekommt diese Variantenfamilie mehr Vertrauen.
Wenn sie mehrfach Belastung erzeugt haette, entsteht mehr Vorsicht oder
Reframing. So entsteht Reife durch Beobachtung.

MCM-Bedeutung:
Das ist der Schritt von blosser Moeglichkeitsbildung zu beobachtender
Moeglichkeitsentwicklung. DIO soll nicht nur "Varianten haben", sondern
erkennen, welche Varianten durch Realitaetskontakt reifen, welche zerfallen
und welche nur Nachhall oder innere Spannung waren.

Neurologische Deutung:
Das entspricht mentalem Probehandeln mit praefrontaler Beobachtung. Der
Organismus muss nicht jede Moeglichkeit motorisch ausfuehren. Er kann sie
halten, beobachten, vergleichen, reifen lassen und erst spaeter naeher an
Handlung bringen.

---

## 18.10 Effizienter Entry aus emergenter Mustervarianz

Ziel:
DIO soll Einstiege nicht aus einer fortlaufenden Einzelkerzenlage ableiten.
Eine laufende Kerze ist nur ein sensorisches Ereignis im Strom. Sie kann eine
Form mitbilden, ist aber keine ausreichende Grundlage fuer Handlung.

Ein effizienter Einstieg entsteht aus einer gereiften These ueber emergente
Mustervarianz:

`Kerzenstrom -> Teilform -> MCM-Feldwirkung -> Variantenraum -> These -> Reife -> moeglicher Entry`

Wichtig:

- Keine einzelne Kerze erzeugt einen Entry.
- Keine reine Momentlage erzeugt einen Entry.
- Eine Formfolge kann mehrere Varianten oeffnen.
- DIO bildet daraus Thesen ueber tragfaehige Bereiche, Fortsetzungen,
  Gegenbewegungen oder Beobachtungsbedarf.
- Erst wenn Form, MCM-Feld, Zeitlage, Erinnerung, Hypothesenreife und
  Prozessqualitaet zusammen tragen, darf daraus Handlungsnaehe entstehen.

Das ist keine harte Regel. Es beschreibt die Faehigkeit:
DIO folgt emergenten Muster- und MCM-Spuren und entwickelt daraus eigene
Entry-Thesen. Der Entry ist dann nicht Impuls aus dem Jetzt, sondern eine
verdichtete, gereifte Handlungsidee aus Mustervarianz.

Beispiel:

DIO sieht nicht: "Diese Kerze ist gruen, also Long."
DIO liest: "Diese Teilform wirkt aehnlich zu einer bekannten Spannungsfamilie.
Die MCM-Wirkung erinnert an eine tragende Variantenfamilie. Wenn diese Form
weiter Kontakt aufbaut, koennte ein effizienter Einstieg in diesem Bereich
entstehen."

MCM-Bedeutung:

Der Entry wird zum Ergebnis einer inneren These. Diese These kann beobachtet,
verworfen, gereift oder spaeter bestaetigt werden. Dadurch entsteht
strategisches Verhalten statt reaktivem Kerzenhandel.
